/**
 * Referentiel NAF rev. 2 (declinaison FR de la NACE).
 *
 * Genere par scripts/generate-naf.mjs — NE PAS EDITER A LA MAIN.
 * Source : https://raw.githubusercontent.com/SocialGouv/codes-naf/master/index.json
 * 732 sous-classes verifiees contre l'enum `activite_principale` de
 * l'API Recherche d'entreprises.
 */

/** Version de la nomenclature couverte par ce fichier. */
export const NAF_VERSION = 'rev2' as const;

/** Les 21 sections NACE/NAF, avec la plage de divisions qu'elles couvrent. */
export const NAF_SECTIONS: Record<string, { label: string; from: number; to: number }> = {
  "A": { label: "Agriculture, sylviculture et peche", from: 1, to: 3 },
  "B": { label: "Industries extractives", from: 5, to: 9 },
  "C": { label: "Industrie manufacturiere", from: 10, to: 33 },
  "D": { label: "Production et distribution d'electricite, de gaz, de vapeur et d'air conditionne", from: 35, to: 35 },
  "E": { label: "Production et distribution d'eau ; assainissement, gestion des dechets et depollution", from: 36, to: 39 },
  "F": { label: "Construction", from: 41, to: 43 },
  "G": { label: "Commerce ; reparation d'automobiles et de motocycles", from: 45, to: 47 },
  "H": { label: "Transports et entreposage", from: 49, to: 53 },
  "I": { label: "Hebergement et restauration", from: 55, to: 56 },
  "J": { label: "Information et communication", from: 58, to: 63 },
  "K": { label: "Activites financieres et d'assurance", from: 64, to: 66 },
  "L": { label: "Activites immobilieres", from: 68, to: 68 },
  "M": { label: "Activites specialisees, scientifiques et techniques", from: 69, to: 75 },
  "N": { label: "Activites de services administratifs et de soutien", from: 77, to: 82 },
  "O": { label: "Administration publique", from: 84, to: 84 },
  "P": { label: "Enseignement", from: 85, to: 85 },
  "Q": { label: "Sante humaine et action sociale", from: 86, to: 88 },
  "R": { label: "Arts, spectacles et activites recreatives", from: 90, to: 93 },
  "S": { label: "Autres activites de services", from: 94, to: 96 },
  "T": { label: "Activites des menages en tant qu'employeurs", from: 97, to: 98 },
  "U": { label: "Activites extra-territoriales", from: 99, to: 99 },
};

/** Les 88 divisions NAF (2 chiffres). */
export const NAF_DIVISIONS: Record<string, string> = {
...
/** Les 732 sous-classes NAF (format `62.01Z`) — granularite du code APE. */
export const NAF_SUBCLASSES: Record<string, string> = {
